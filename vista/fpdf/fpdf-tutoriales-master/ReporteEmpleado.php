...
class PDF extends FPDF
{
   ...
   function Header()
   {
     include '../../../modelo/conexion.php';//llamamos a la conexion BD
      ...
      $this->Image('logo.png', 230, 5, 55); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      ...
      $this->Cell(60, 10, utf8_decode('CARGO'), 1, 0, 'C', 1);
      $this->Cell(70, 10, utf8_decode('CORREO'), 1, 1, 'C', 1);
   }
...
$consulta_reporte_empleado = $conexion->query("select empleado.nombre, empleado.apellido,empleado.dni,empleado.correo,cargo.nombre as 'nomCargo' from empleado
...
while ($datos_reporte = $consulta_reporte_empleado->fetch_object()) {
   ...
   $pdf->Cell(100, 10, utf8_decode($datos_reporte->nombre ." ".$datos_reporte->apellido), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->dni), 1, 0, 'C', 0);
   $pdf->Cell(60, 10, utf8_decode($datos_reporte->nomCargo), 1, 0, 'C', 0);
   $pdf->Cell(70, 10, utf8_decode($datos_reporte->correo), 1, 1, 'C', 0);
